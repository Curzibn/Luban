...
import package top.zibin.luban.AsyncExecutor;
...
public class ImageCompressUtils {
    ...
    public static ImageCompressUtils from(Context context) {
        if (INSTANCE == null) {
            INSTANCE = new ImageCompressUtils(context);
        }
        return INSTANCE;
    }
    ...
    public ImageCompressUtils setCompressListener(OnCompressListener listener) {
    ...
    public ImageCompressUtils launch() {
        if (mFile == null) {
